<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('¿Seguro que quieres eliminar tu cuenta? Una vez eliminada, todos sus recursos y datos se borrarán permanentemente. Introduce tu contraseña para confirmar que deseas eliminar tu cuenta definitivamente.') }}
